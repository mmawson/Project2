...
public class MovieData {
    ...
    public MovieData(){
        ...
        moviesList.add(createMovie("The Hunger Games", R.drawable.hunger_games_second, description, year, length, rating, director, stars, url));
		year = "2002";
		length = "121 min";
		rating = 7.3;
		director = "Sam Raimi" ;
	...
	public double getReview(int i) {
		return (double) getItem(i).get("rating");
	}
